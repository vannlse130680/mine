<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="">FPT University HCM 🏫
      </TitleFunction>
    </TitleSection>
...
<!--          From Jan 2020 to May 2019 I was working as-->
<!--          <strong class="-purple">Backend Developer</strong>-->
<!--          @-->
<!--          <a-->
...
<!--          >.-->
        ...
        <p>
          o C-Blue YDeveloper, OOP-Blue YDeveloper


        </p>
        <p>o Honorable student of semester: 1, 2, 3, 5, 7</p>
        <p>o Tuition fee scholarship: 70% (4 years)</p>
        <p>o Quality: Very good</p>
      </TextBlock>
      <template #container>
    ...
    <SceneSection id="biz2">
      <TextBlock>
        ...
        <p>
          ReactJS, VueJS, Java, OOP/UML/Design Patterns. C#, MSSQL, HTML, CSS, JavaScript, Spring Boot, Postgresql, Android Mobile Programming.
        </p>
      </TextBlock>
    </SceneSection>
    <SceneSection id="biz3">
      <TextBlock>
        ...
        <p class="">
            working as the BE Developer with SpingBoot framework at
            <span class="-purple">FPT Software</span>
          </p>
      </TextBlock>
    </SceneSection>
  </div>
